    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/h2-console/**", "/api/login", "/api/register", "/login", "/register").permitAll() // Allow access to h2-console, login, and register endpoints (both /api/* and /*) without authentication
